...
class Rossman():
    ...
    def training(self,train_path,store_path,PATH_STORE_MODIFIED,LOG=False):
    ...
    def testing(self,path_test,PATH_STORE_MODIFIED,LOG =False):
        ...
        if LOG ==True:
            RMSPE = metric(y_predict, np.log(y.to_numpy()))
        else:
